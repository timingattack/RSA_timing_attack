...
OFLAGS=-I inc
EXEC=main.exe
SRC=main.c square_multiply.c chiffrement.c dechiffrement.c creation_des_cles.c miller_rabin.c rsa.c
OBJ=$(SRC:.c=.o)
DIR_EXEC=bin
DIR_OBJ=obj
DIR_SRC=src
...
rsa.o: chiffrement.h dechiffrement.h creation_des_cles.h
